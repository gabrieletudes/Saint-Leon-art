<div class="">
  <footer class="c-footer o-content-wrapper u-padding-vertical-large c-bg-color--purple">
    <div class="o-flex o-flex--wrap">
        <div class="o-layout__item  u-1/1@mobile u-3/12@desktop o-flex o-flex--wrap u-padding-right-small o-flex__item">
        ...
        <div class="o-layout__item  u-1/1@mobile u-4/12@tablet u-2/12@desktop u-padding-right-small o-flex__item">
          <h4 class="u-margin-bottom-small c-h--white">Menu</h4>
        ...
        <div class="o-layout__item  u-1/1@mobile u-6/12@tablet u-3/12@desktop u-padding-right-small o-flex__item">
          <h4 class="u-margin-bottom-small c-h--white">Contactez-nous</h4>
          <ul class="o-list-bare">
        ...
        <div class="c-newsletter o-layout__item  u-1/1@mobile u-3/4@tablet u-4/12@desktop c-bg-color--shadow-white u-padding u-padding-bottom-large o-flex o-flex--wrap">
          <h4 class="c-h--purple">NEWSLETTER</h4>
        ...
        <form action="" class="c-newsletter-form o-flex o-flex--wrap">
          ...
          <button class="o-flex o-flex--centered-v c-btn c-btn--submit c-btn--small c-btn--primary" type="submit" name="">Souscrir</button>
        </form>
        </div>
      </div>
    </footer>
    <p class="o-content-wrapper u-padding-vertical-small u-margin-bottom-none c-bg-color--purple-light-10 o-flex o-flex--wrap o-flex--centered">
      <small class="o-flex__item u-margin-right u-margin-right@mobile-none">Copyright © 2017 Saint Leon’art. Tous droits réservés.</small>
      <small class="o-flex__item">Crafted with <span class="c-footer__icon--heart">love</span> by <a class="c-footer__maker-link" href="http://martinz.be">MARTINZ</a></small>
    </p>
  </div>
</div><!--END Site Pusher-->
</div><!--END Hidder-->
